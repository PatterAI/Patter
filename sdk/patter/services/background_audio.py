...
* ``rtc.AudioMixer`` is replaced by :class:`patter.services.pcm_mixer.PcmMixer`,
...
from patter.providers.base import BackgroundAudioPlayer as _BaseBackgroundAudioPlayer
from patter.services.pcm_mixer import PcmMixer
...
class BuiltinAudioClip(enum.Enum):
    ...
    def path(self) -> str:
        ...
        """
        ref = resources.files("patter.resources.audio") / self.value
    ...
    def __init__(
        ...
        *,
        ...
        if not _AUDIO_DEPS_AVAILABLE:
            raise ImportError(
                "patter.services.background_audio requires numpy and "
