...
const tts = new LowLevelTTS("<api-key>", { voice: "eve", codec: "pcm", sampleRate: 16000 });
...
<CardGroup cols={2}>
  <Card title="TTS" icon="volume" href="/typescript-sdk/tts">All TTS providers side by side.</Card>
  <Card title="xAI STT" icon="waveform" href="/typescript-sdk/providers/xai-stt">Grok speech-to-text.</Card>
