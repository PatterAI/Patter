---
title: "Patter: Voice AI SDK for phone calls"
description: "Connect any AI agent to phone calls with 10 lines of code. Patter handles telephony, speech-to-text, and text-to-speech so you can focus on your agent."
---

# Patter

Connect any AI agent to phone calls with 10 lines of code. Patter handles telephony, speech-to-text, and text-to-speech so you can focus on your agent.

Patter is an open-source SDK that gives your AI agent a voice and a phone number. Point it at any function that returns a string and Patter handles the rest — telephony, speech-to-text, text-to-speech, and real-time audio streaming. Works with Python and TypeScript, supports Twilio and Telnyx, and runs in both local and self-hosted modes.
