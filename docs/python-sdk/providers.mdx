...
| `endpointing_ms` | `int` | `150` | Milliseconds of silence after final transcription. |
| `utterance_end_ms` | `int` | `1000` | Milliseconds before ending an utterance. |
| `vad_events` | `bool` | `True` | Enable voice activity detection events. |
