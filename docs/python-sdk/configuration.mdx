...
| `backend_url` | `str` | `"wss://api.getpatter.com"` | WebSocket URL for the Patter backend. Override for self-hosted deployments. |
| `rest_url` | `str` | `"https://api.getpatter.com"` | REST API URL for the Patter backend. Override for self-hosted deployments. |
