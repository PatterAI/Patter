...
The following adapters live in `patter.providers` and are safe to call directly from `on_message`:

| Provider | Module | Install extra |
|----------|--------|---------------|
| Anthropic | `patter.providers.anthropic_llm` | `getpatter[anthropic]` |
| Google Gemini | `patter.providers.google_llm` | `getpatter[google]` |
| Groq | `patter.providers.groq_llm` | `getpatter[groq]` |
| Cerebras | `patter.providers.cerebras_llm` | `getpatter[cerebras]` |
| Ultravox (realtime) | `patter.providers.ultravox_realtime` | `getpatter[ultravox]` |
